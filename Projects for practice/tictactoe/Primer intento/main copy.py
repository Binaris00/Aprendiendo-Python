...
def act_cuadro(par):
    ...
    opciones_resp_j = ("1j", "2j", "3j", "4j", "5j", "6j", "7j", "8j", "9j")
    opciones_resp_r = ("1r", "2r", "3r", "4r", "5r", "6r", "7r", "8r", "9r")
    if par in opciones_resp_j:
        par = "# O #"
    elif par in opciones_resp_r:
        par = "# O #"
    else:
